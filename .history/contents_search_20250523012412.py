...
def get_details(content_id, media_type, lang="ko"):
    try:
        details_url = f"{BASE_URL}/{media_type}/{content_id}"
        credits_url = f"{BASE_URL}/{media_type}/{content_id}/credits"
        ...
        production = details.get("production_companies", [])
        ...
        return {"production_companies": [], "cast": []}
